...
public enum BrowserType implements DriverSetup {
  ...
  FIREFOX {
    ...
    private @NotNull FirefoxOptions getOptions(@NotNull DesiredCapabilities capabilities) {
      ...
      String userAgent = "Mozilla/5.0 (Macintosh; Intel Mac OS X 10.15; rv:79.0) Gecko/20100101 "
          + "Firefox/79.0";
      ...
      testProfile.setPreference("general.useragent.override", userAgent);
  ...
  CHROME {
    ...
    private @NotNull ChromeOptions getOptions(DesiredCapabilities capabilities) {
      ...
      String userAgent = "\"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_6) AppleWebKit/537.36 "
